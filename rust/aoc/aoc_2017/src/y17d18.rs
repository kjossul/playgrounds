...
impl Program {
    pub fn step(&mut self, instructions: &[Instruction]) -> Option<i64> {
    ...
    pub fn set(&mut self, args: &[String]) -> Option<i64> {
        *self.get_value(&args[0]) = *self.get_value(&args[1]);
        None
    }

    pub fn add(&mut self, args: &[String]) -> Option<i64> {
        *self.get_value(&args[0]) += *self.get_value(&args[1]);
        None
    }

    pub fn sub(&mut self, args: &[String]) -> Option<i64> {
        *self.get_value(&args[0]) -= *self.get_value(&args[1]);
        None
    }

    pub fn mul(&mut self, args: &[String]) -> Option<i64> {
        *self.get_value(&args[0]) *= *self.get_value(&args[1]);
        self.nmuls += 1;
        None
    }

    pub fn modulus(&mut self, args: &[String]) -> Option<i64> {
        *self.get_value(&args[0]) %= *self.get_value(&args[1]);
        None
    }

    pub fn jgz(&mut self, args: &[String]) -> Option<i64> {
    ...
    pub fn jnz(&mut self, args: &[String]) -> Option<i64> {
        if *self.get_value(&args[0]) != 0 {
            self.pc += *self.get_value(&args[1]) - 1;
        }
        None
    ...
    pub fn snd1(&mut self, args: &[String]) -> Option<i64> {
        self.frequency = *self.get_value(&args[0]);
        None
    }

    pub fn rcv1(&mut self, args: &[String]) -> Option<i64> {
        if *self.get_value(&args[0]) != 0 {
            Some(self.frequency)
        } else {
            None
    ...
    pub fn snd2(&mut self, args: &[String]) -> Option<i64> {
        Some(*self.get_value(&args[0]))
    }

    pub fn rcv2(&mut self, args: &[String]) -> Option<i64> {
    ...
    pub fn get_value(&mut self, arg: &String) -> &mut i64 {
...
pub fn parse_program(input: &str, part2: bool) -> (Program, Vec<Instruction>) {
